...
QUnit.test( "Test Latin", function( assert ) {
    ...
    assert.ok( jQuery("ul > li:nth-child(2)").text() === "Primerr rečenice koja sadrži reči koje ne ulaze u transliteraciju: Ovaj plugin je pisan za jQuery.", jQuery("ul > li:nth-child(2)").text() );
